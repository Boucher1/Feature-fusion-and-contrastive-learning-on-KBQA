...
def parse_args_train():
	...
	# 超参数kesai
	parser.add_argument("--kesai", type=float, default=0.1)
	# beam search k
	...
	parser.add_argument("--train_file", type=str, default="data/webQSP/mask_data/train_allpath_mask_e_shuffle.csv")
	...
	# parser.add_argument("--train_file", type=str, default="data/complexQA/mask_data/train_allpath.csv")
	# parser.add_argument("--dev_file", type=str, default="data/complexQA/mask_data/valid_allpath_oversampleshuffle.csv")
	# parser.add_argument("--test_file", type=str, default="data/complexQA/mask_data/test_allpath_NoCons.csv")
	...
	args.output_path = join(args.output_path, args.train_mode,
							'{}-GRU-CNN-Attention-{}-bsz-{}-lr-{}-drop-{}-allpath'.format(args.pretrain_model_path.split('/')[-1], args.dataset, args.batch_size_train, args.lr, args.dropout))
	return args
